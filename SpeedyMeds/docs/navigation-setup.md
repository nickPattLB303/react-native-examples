...
2.  **Native Stack Navigator:** As the root navigator. This allows screens (like Order Details) to be pushed *on top* of the tab bar, providing a standard modal/detail view behavior.
