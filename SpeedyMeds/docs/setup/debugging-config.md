...
*   **Usage:**
    ...
    2.  Launch the React Native Debugger application *before* enabling remote debugging.
...
*   **Expo Integration:** Using Flipper with the Expo *managed workflow* can sometimes require specific setup or might have limitations compared to bare React Native projects, although Expo is continuously improving compatibility. It often requires a development build (`npx expo run:ios` or `npx expo run:android`).
