...
>
> **Source:** [Core Animation Programming Guide (iOS)](https://developer.apple.com/library/archive/documentation/Cocoa/Conceptual/CoreAnimation_guide/Introduction/Introduction.html), [Property Animation (Android)](https://developer.android.com/guide/topics/graphics/prop-animation)
...
| --------------------- | ---------------------------------------------------------------------------- | --------------------------------------- |
| **Primary Goal**      | Initial declarative animation solution                                       | High-performance, UI thread animations  |
...
| **Bridge Dependency** | For JS-driven updates                                                        | Minimized (uses JSI)                    |
| **Ecosystem**         | Built-in to React Native                                                     | Third-party library (de facto standard) |
...
### Why Reanimated is Preferred for New Development
