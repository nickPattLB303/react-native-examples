...
### The General App Store Submission Workflow
...
1.  **Developer Program Enrollment:** You must be enrolled in the Apple Developer Program (for iOS) and have a Google Play Developer account (for Android).
2.  **App Store Listing Preparation:** This involves creating your app's presence on the respective store consoles (App Store Connect and Google Play Console). You'll need to provide:
    ...
    - Contact Information
3.  **Uploading the Binary:** You upload your `.ipa` (iOS) or `.aab` (Android) file to the store console.
4.  **Pre-Submission Checks:** Both platforms perform automated checks on your uploaded binary for common issues.
5.  **Submitting for Review:** Once you're satisfied with your listing and binary, you submit the app for review by the platform's review team.
6.  **App Review Process:** Apple and Google reviewers will test your app to ensure it meets their guidelines regarding content, functionality, security, and user experience.
7.  **Release:** If your app passes the review, you can release it to the store immediately or schedule a release date.

This process can be time-consuming and requires careful attention to detail to avoid rejections.

### Introduction to EAS Submit
...
- **Platform-Specific (`android`, `ios`):** Configurations are nested under platform keys.
- **Android:**
...
- **Apple's App Review:** Known for being thorough, focusing on UI/UX, security, privacy, and content. [App Store Review Guidelines](https://developer.apple.com/app-store/review/guidelines/)
- **Google's App Review:** Also comprehensive, covering similar aspects. [Developer Policy Center](https://play.google.com/policy/)

### Common Rejection Reasons & Handling

- **Crashes or Bugs:** Thoroughly test your app before submission.
- **Incomplete Information:** Ensure all required metadata in the store listing is complete and accurate.
- **Guideline Violations:** Carefully read and follow the platform guidelines.
- **Poor User Experience:** Ensure your app is intuitive and provides value.
- **Privacy Concerns:** Clearly state your data handling practices in your privacy policy and within the app if necessary.
...
> - [Expo Docs: Submitting to Apple App Store](https://docs.expo.dev/submit/ios/)
> - [Expo Docs: Submitting to Google Play Store](https://docs.expo.dev/submit/android/)
> - [Apple App Store Connect](https://appstoreconnect.apple.com/)
> - [Google Play Console](https://play.google.com/console/)

---

_Next: [Section 8: EAS Update (Over-the-Air Updates)](./section-08-eas-update.md)_
