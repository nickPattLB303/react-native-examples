...
- Using browser-based tools like Expo Snack and CodeSandbox
- Running web-based exercises

Any of these browsers will work well:
...
- Automatic saving and previewing
...
- Browser-based React Native development
- Instant previews on web or Expo Go app
- Shareable links for your projects
- Access to most Expo SDK features
...
- Check with your instructor about the official channel for questions (e.g., Microsoft Teams, Slack, Discord)
- Use the appropriate channels for different types of questions:
  - Technical issues
...
- Digital options: OneNote, Notion, Evernote, or simple Markdown files
- Physical notebook for diagrams and quick notes
- Code snippets repository for useful patterns you discover

> 🧑‍🏫 **(Instructor-Led):** Your instructor might provide specific platforms for submitting assignments or asking questions. Make sure to note these details during your first session.
...
- Setting up Expo CLI
- Installing Xcode (macOS) and/or Android Studio
