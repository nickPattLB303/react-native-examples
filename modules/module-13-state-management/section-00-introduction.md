...
- [React Docs: State Management](https://react.dev/reference/react/useState#sharing-state-between-components) - Official React documentation on sharing state.
- [Choosing a State Management Library](https://www.robinwieruch.de/react-state-management-libraries/) - A blog post offering perspectives on different state management libraries (though focused on React web, many principles apply).
