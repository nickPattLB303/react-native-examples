...
>
> **Key Takeaway:** You'll work primarily with command-line tools and external editors rather than a single IDE like Xcode.
>
> **Source:** [Xcode Overview](https://developer.apple.com/xcode/)

> 🤖 **Android Developers:**
>
> **Comparison:** Similar to Android Studio's SDK Manager and Gradle build system, Expo handles dependency management and build processes. However, instead of managing multiple SDK versions and build variants manually, Expo abstracts much of this complexity while still providing access to native features.
>
...
- Install and configure all necessary prerequisites for React Native development
...
- Configure and run applications on the iOS Simulator
- Navigate and understand the Expo project structure
- Execute essential Expo CLI commands for development workflows
- Identify and resolve common setup and configuration issues
- Utilize Expo Snack for rapid prototyping and learning

## Prerequisites

- Basic familiarity with command-line interfaces (Terminal on macOS, Command Prompt or PowerShell on Windows)
- Understanding of package managers (npm or yarn) from web development experience
- Completion of Module 0: Course Introduction
- Access to a macOS computer (required for iOS Simulator usage covered in this course)

> [!IMPORTANT]
> This course focuses on iOS development using the iOS Simulator. While Expo supports both iOS and Android development, the setup instructions and examples primarily target macOS and iOS for consistency and clarity.
...
5. [Running on the iOS Simulator](./section-05-running-on-the-ios-simulator.md)
...
This module established your React Native development foundation using Expo. You've learned to install and configure essential prerequisites, create new projects using modern Expo tools, and understand the relationship between Expo CLI and traditional Node.js package managers. You've also gained hands-on experience running applications on the iOS Simulator, navigating project structures, and executing key development commands.
