...
```
Changes require restarting the Metro bundler, often with the --clear flag (npx expo start --clear) to ensure the cache is updated. - [Install Expo Router - Expo Documentation](https://docs.expo.dev/router/installation/)
...
-   --tunnel: Starts a tunnel using ngrok, providing a publicly accessible HTTPS URL for the development server. - [Migrate from React Native CLI to Expo CLI - Expo Documentation](https://docs.expo.dev/bare/using-expo-cli/) This is useful for:
...
-   Working in environments with restrictive firewalls.\
    Note: Tunneling can be slower than local connections, and the URL is public. May require installing @expo/ngrok globally (npm i -g @expo/ngrok). - Expo CLI - Expo Documentation
...
-   Tool: Expo Snack ([snack.expo.dev](https://snack.expo.dev/))
...
Expo Go is a pre-built native application, available for free from the [Google Play Store](https://play.google.com/store/apps/details?id=host.exp.exponent) and [Apple App Store](https://apps.apple.com/us/app/expo-go/id982107779), developed and maintained by the Expo team. - [Set up your environment - Expo Documentation](https://docs.expo.dev/get-started/set-up-your-environment/)
...
-   No Custom Native Code: The most significant limitation. Expo Go's native code is fixed; it cannot load or run any third-party native modules or custom native code that isn't already part of the pre-built Expo SDK version it includes. - [Expo Go vs Development Builds: Which should you use?](https://expo.dev/blog/expo-go-vs-development-builds) Attempting to use such libraries (e.g., react-native-firebase, specific hardware interaction modules) will result in runtime errors because the corresponding native implementation is missing. - [Introduction to development builds - Expo Documentation](https://docs.expo.dev/develop/development-builds/introduction/)
...
-   Potential Behavior Discrepancies: Because the app runs under Expo Go's bundle identifier/package name, certain integrations or platform behaviors might differ slightly compared to a standalone production build. - [Expo Go vs Development Builds: Which should you use?](https://expo.dev/blog/expo-go-vs-development-builds)
...
To create a Development Build, the expo-dev-client library must be installed in the project (npx expo install expo-dev-client). - [Local app development - Expo Documentation](https://docs.expo.dev/guides/local-app-development/) This library injects development features into the debug build, including:
...
| Setup | Install from App Store - Set up your environment - Expo Documentation | Build via EAS or Locally - Create a development build - Expo Documentation | Build via EAS Build - docs.expo.dev |

| Custom Native Code | No - Introduction to development builds - Expo Documentation | Yes - Create a development build - Expo Documentation | Yes |

| Third-Party Native Libs | Only pre-included Expo SDK - Expo Go vs Development Builds: Which should you use? | Any - Create a development build - Expo Documentation | Any |

| Native Config Testing | Limited (Icon/Splash Emulation) - Introduction to development builds - Expo Documentation | Yes (Full: Icon, Splash, Push, Links) - Introduction to development builds - Expo Documentation | N/A (Is the final config) |

| Remote Push Notifications | No - Introduction to development builds - Expo Documentation | Yes - Introduction to development builds - Expo Documentation | Yes |

| Deep Linking (App/Univ.) | No - Introduction to development builds - Expo Documentation | Yes - Introduction to development builds - Expo Documentation | Yes |

| Developer Tools | Built-in (Dev Menu, Fast Refresh) - Introduction to development builds - Expo Documentation | Included via expo-dev-client - Create a development build - Expo Documentation | No |

| Use Case | Learning, Prototyping, Simple SDK tests - Set up your environment - Expo Documentation | Development, Full Feature Testing - Expo Go vs Development Builds: Which should you use? | App Store Distribution, Release - Create a development build - Expo Documentation |

| Creation Method | Download - Set up your environment - Expo Documentation | eas build --profile development or npx expo run:[platform] - Create a development build - Expo Documentation | eas build --profile production - Create a development build - Expo Documentation |
...
-   Search the Community: Look for solutions on Stack Overflow, the Expo Forums ([forums.expo.dev](https://forums.expo.dev/)), the Expo Discord server ([chat.expo.dev](https://chat.expo.dev/)), or relevant GitHub repositories. - [Troubleshoot build errors and crashes - Expo Documentation](https://docs.expo.dev/build-reference/troubleshooting/) Provide clear details and error logs when asking for help.
...
-   Problem: "Unable to resolve module <module_name>" error. - [Troubleshoot](https://docs.expo.dev/build-reference/troubleshooting/) build errors and crashes - Expo[ Documentation](https://docs.expo.dev/build-reference/troubleshooting/)
...
-   Tool: Expo Snack ([snack.expo.dev](https://snack.expo.dev/)) or a provided Git repository branch.
...
1.  Verify: Ensure the application runs without errors in the previews after applying the fixes. The kiosk should display correctly.

2.  Document: Briefly describe the errors encountered and the steps taken to resolve each one.
...
-   Zero Setup: The most significant advantage for learners is the complete elimination of local environment setup for basic tasks. Participants can start writing and running React Native code immediately. - [Get Support - Expo](https://expo.dev/support/snack)

-   Easy Sharing & Embedding: Snacks can be saved and shared via a simple URL, making it easy to share code examples, bug reproductions, or exercise solutions. - [Get Support - Expo](https://expo.dev/support/snack) They can also be embedded directly into websites or documentation platforms. - [Get Support - Expo](https://expo.dev/support/snack)
...
-   Not for Complex Projects: Snack is designed for smaller code examples and experiments, not for managing large, multi-feature applications or long-term development efforts. - [Get Support - Expo](https://expo.dev/support/snack)

-   API Limitations: Certain APIs might have limitations within the Snack environment (e.g., web-specific APIs like Web Share might be restricted by the browser context Snack runs in). - [Sharing - Expo Documentation](https://docs.expo.dev/versions/latest/sdk/sharing/)
